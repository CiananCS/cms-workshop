...
## Everything above is setting up the definitions. Everything below is code exectution
    ...
    for num1 in range(0,num_atoms):
         for num2 in range(0,num_atoms):
             if num1<num2:
                 ...
                 if bond_check(bond_length_12,args.minimum_length,args.maximum_length) is True:
